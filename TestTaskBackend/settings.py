"""
Django settings for TestTaskBackend project.
...
SECRET_KEY = 'django-insecure-l^pg$a=&10!o@fzd$y@&(oqs(l@$+y$*3+p(7%_j$_@e8z-)8f'
...
ROOT_URLCONF = 'TestTaskBackend.urls'
...
WSGI_APPLICATION = 'TestTaskBackend.wsgi.application'
